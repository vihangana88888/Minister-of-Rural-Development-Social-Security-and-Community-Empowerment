...
const footwearProjects = [
  {
    id: 1,
    name: "Habaraduwa Footwear Craft Zone",
    district: "Galle",
    office: "Habaraduwa",
    product: "Handmade sandals, slippers, eco-leather shoes",
    location: "Habaraduwa",
    buyPath: "/buy/habaraduwa-footwear",
    description:
      "This zone supports footwear artisans in Habaraduwa with training, tools, and cooperative marketing. It promotes sustainable materials and connects producers to fashion and tourism markets.",
    mapEmbed:
...
const FootwearPage = () => {
  const [selectedProject, setSelectedProject] = useState(footwearProjects[0]);
  ...
  return (
    <div className="min-h-screen bg-white px-6 py-10 space-y-10">
      <h1 className="text-2xl font-bold text-[#2C3E50] mb-6">Footwear Related Product</h1>

      {/* Table Section */}
      <div className="overflow-x-auto mb-6">
        <table className="min-w-full border border-gray-300">
          <thead className="bg-[#DCD0A8] text-white">
            <tr>
          ...
          <tbody>
            {footwearProjects.map((item) => (
              <tr
                key={item.id}
                className="hover:bg-[#FFF9E5] cursor-pointer"
              ...
              >
                ...
                <td className="px-4 py-2 border">
                  <a
                    href={item.buyPath}
                    className="text-blue-600 underline hover:text-[#DCD0A8]"
      ...
      >
        ...
        <div className="w-full lg:w-1/2 h-[400px] bg-[#FFF9E5] p-6 rounded-md shadow-md overflow-y-auto">
          <h2 className="text-xl font-bold text-[#DCD0A8] mb-2">{selectedProject.name}</h2>
