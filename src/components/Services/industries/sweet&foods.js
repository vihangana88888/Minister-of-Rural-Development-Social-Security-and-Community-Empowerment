...
const sweetFoodProjects = [
  ...
  //   district: "Kurunegala",
  //   office: "Kobeigane",
  //   project: "Village Food Packaging & Branding",
  //   amount: "Rs. 32,000",
  //   location: "Kobeigane",
  //   mapEmbed:
  ...
  //   district: "Galle",
  //   office: "Habaraduwa",
  //   project: "Sweet & Snack Festival Promotion",
  //   amount: "Rs. 36,000",
  //   location: "Habaraduwa",
  //   mapEmbed:
...
const SweetFoodsPage = () => {
  const [selectedMap, setSelectedMap] = useState(sweetFoodProjects[0].mapEmbed);

  return (
    <div className="min-h-screen bg-white px-6 py-10">
      <h1 className="text-2xl font-bold text-[#2C3E50] mb-6">Sweet & Foods Related Product</h1>

      {/* Table Section */}
      <div className="overflow-x-auto mb-10">
        <table className="min-w-full border border-gray-300">
          <thead className="bg-[#FAC67A] text-white">
            <tr>
          ...
          <tbody>
            {sweetFoodProjects.map((item) => (
              <tr
                key={item.id}
                className="hover:bg-[#F9E6CF] cursor-pointer"
