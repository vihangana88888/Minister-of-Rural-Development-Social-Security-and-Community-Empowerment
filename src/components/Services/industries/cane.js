...
const caneProjects = [
  {
    ...
    district: "Kandy",
    office: "Udunuwara",
    project: "Cane Furniture Making Training",
    amount: "Rs. 28,000",
    location: "Udunuwara",
    mapEmbed:
  ...
  },
  {
    ...
    district: "Kurunegala",
    office: "Kobeigane",
    project: "Cane Product Packaging & Branding",
    amount: "Rs. 32,000",
    location: "Kobeigane",
    mapEmbed:
  ...
  },
  {
    ...
    district: "Galle",
    office: "Habaraduwa",
    project: "Cane Basket Weaving Promotion",
    amount: "Rs. 36,000",
    location: "Habaraduwa",
    mapEmbed:
...
const CanePage = () => {
  const [selectedMap, setSelectedMap] = useState(caneProjects[0].mapEmbed);
