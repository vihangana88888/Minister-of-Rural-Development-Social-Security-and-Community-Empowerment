...
const otherSpecialProjects = [
  {
    id: 1,
    district: "Kandy",
    office: "Udunuwara",
    project: "Special Artisan Empowerment Program",
    amount: "Rs. 30,000",
    location: "Udunuwara",
    mapEmbed:
  ...
  },
  {
    ...
    district: "Kurunegala",
    office: "Kobeigane",
    project: "Unique Village Product Branding",
    amount: "Rs. 34,000",
    location: "Kobeigane",
    mapEmbed:
  ...
  },
  {
    ...
    district: "Galle",
    office: "Habaraduwa",
    project: "Special Cultural Product Showcase",
    amount: "Rs. 38,000",
    location: "Habaraduwa",
    mapEmbed:
...
const OtherSpecialPage = () => {
  const [selectedMap, setSelectedMap] = useState(otherSpecialProjects[0].mapEmbed);

  return (
    <div className="min-h-screen bg-white px-6 py-10">
      <h1 className="text-2xl font-bold text-[#2C3E50] mb-6">Other Special Related Product</h1>
      ...
      <div className="w-full h-[400px] rounded-md overflow-hidden shadow-lg">
        <iframe
          title="Other Special Project Map"
          src={selectedMap}
          width="100%"
          height="100%"
          style={{ border: 0 }}
...
export default OtherSpecialPage;
