...
const beeHoneyProjects = [
  {
    ...
    district: "Kandy",
    office: "Udunuwara",
    project: "Bee Honey Collection & Training Program",
    amount: "Rs. 24,000",
    location: "Udunuwara",
    mapEmbed:
  ...
  },
  {
    ...
    district: "Monaragala",
    office: "Wellawaya",
    project: "Organic Bee Honey Processing Unit",
    amount: "Rs. 36,000",
    location: "Wellawaya",
    mapEmbed:
  ...
  },
  {
    ...
    district: "Kurunegala",
    office: "Kobeigane",
    project: "Bee Hive Expansion & Support",
    amount: "Rs. 32,000",
    location: "Kobeigane",
    mapEmbed:
...
const BeeHoneyPage = () => {
  const [selectedMap, setSelectedMap] = useState(beeHoneyProjects[0].mapEmbed);
