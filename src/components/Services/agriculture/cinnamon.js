...
const cinnamonProjects = [
    {
                ...
                buyPath: "/buy/ambalangoda-betel",
                description:
                  "This market connects traditional betel growers with buyers across the Southern Province. It preserves cultural practices while improving income through cooperative selling.",              },
              {
                id: 2,
                district: "Hambantota",
                office: "Tangalla",
    ...
    return (
      <div className="min-h-screen bg-white px-6 py-10 space-y-10">
              ...
              {cinnamonProjects.map((item) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 border">
                    <a
                      href={item.buyPath}
                      className="text-blue-600 underline hover:text-[#A76545]"
        ...
        >
          ...
          <div className="w-full lg:w-1/2 h-[400px] bg-[#F5EAE5] p-6 rounded-md shadow-md overflow-y-auto">
            <h2 className="text-xl font-bold text-[#A76545] mb-2">{selectedProject.name}</h2>
